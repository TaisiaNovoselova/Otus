...
@pytest.mark.parametrize('number, count', [(-1, 1), (0, 1), (15, 15), (51, 50)])
...
@pytest.mark.parametrize('breed, status_code', [("chihuahua", 200), ("dog", 404)])
...
@pytest.mark.parametrize('breed, count, status_code', [("chihuahua", 30, 200), ("dog", 22, 404)])
...
@pytest.mark.parametrize('breed, status_code', [("chihuahua", 200), ("dog", 404)])
def test_sub_breed_param(breed, status_code):
